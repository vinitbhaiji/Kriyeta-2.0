...
<html data-wf-domain="frenzzy.webflow.io" data-wf-page="6579681c5435b99c06ed37d9" data-wf-site="6577019a915bb98abc733614"
    lang="en">
        ...
        <div class="w-layout-blockcontainer main-container w-container">
            <div data-animation="default" data-collapse="medium" data-duration="400" data-easing="ease"
                ...
                <nav role="navigation" class="main-menu w-nav-menu"><a href="index.html"
                        ...
                        class="menu-item w-nav-link">shop</a><a href="contact.html" aria-current="page"
        ...
        <div class="w-layout-blockcontainer main-container w-container">
            ...
            <div class="contact-form-block w-form">
                ...
                <form id="email-form" name="email-form" data-name="Email Form" method="get"
                    ...
                    data-wf-element-id="b057ea1d-e3ce-c840-7e56-51fe53607294">
                    <div id="w-node-_898cb840-74df-5f6e-2aa5-2965ec797a8b-06ed37d9"
                        ...
                        <div id="w-node-_898cb840-74df-5f6e-2aa5-2965ec797a8c-06ed37d9"
                            class="w-layout-cell form-cell"><input class="input-style w-input" maxlength="256"
                                name="name" data-name="Name" placeholder="Name *" type="text" id="name"
                                required="" /></div>
                        <div id="w-node-_898cb840-74df-5f6e-2aa5-2965ec797a8d-06ed37d9"
                            class="w-layout-cell form-cell"><input class="input-style w-input" maxlength="256"
                                name="Last-Name" data-name="Last Name" placeholder="Last Name *" type="text"
                        ...
                        <div id="w-node-_4593c067-a721-583c-fe46-0882eafb983e-06ed37d9"
                            class="w-layout-cell form-cell"><input class="input-style w-input" maxlength="256"
                                name="Phone-Number" data-name="Phone Number" placeholder="Phone Number"
                                type="tel" id="Phone-Number" /></div>
                        <div id="w-node-ab80280f-afbb-bacc-2bb5-f542c8490ea2-06ed37d9"
                            class="w-layout-cell form-cell"><input class="input-style textarea w-input"
                                maxlength="256" name="Message" data-name="Message" placeholder="Message *"
                                type="text" id="Message" required="" /></div>
                    </div>
            ...
            <div class="w-layout-blockcontainer main-container w-container">
                <div id="w-node-dd3feab8-20cd-504e-dfab-1b390f44e31c-0f44e319"
                    ...
                    <div id="w-node-dd3feab8-20cd-504e-dfab-1b390f44e336-0f44e319"
                        ...
                        <div class="w-form">
                            <form id="email-form" name="email-form" data-name="Email Form" method="get"
                                class="form" data-wf-page-id="6579681c5435b99c06ed37d9"
