...
<html data-wf-domain="frenzzy.webflow.io" data-wf-page="65795d101c18091a4cfc731f" data-wf-site="6577019a915bb98abc733614"
    lang="en">
        ...
        <div class="w-layout-blockcontainer main-container w-container">
            <div data-animation="default" data-collapse="medium" data-duration="400" data-easing="ease"
                ...
                <nav role="navigation" class="main-menu w-nav-menu"><a href="index.html"
                        class="menu-item w-nav-link">Home</a><a href="about.html" aria-current="page"
                        class="menu-item w-nav-link w--current">About</a><a href="categories.html"
...
"
        ...
        <div class="w-layout-blockcontainer main-container w-container">
            <div id="w-node-_3740d9dd-9ddb-7f94-7123-fbf6dd1d3aa4-4cfc731f"
                ...
                <div id="w-node-_3740d9dd-9ddb-7f94-7123-fbf6dd1d3aa5-4cfc731f" class="w-layout-cell about-cell">
                    <div class="about-upper"><img src="../images/657979eea1a826641fd98d99_socials_22.png"
                            loading="lazy" alt="" class="about-svg" />
                        <p class="about-paragraph">We&#x27;re powered by our unwavering devotion to rafting engaging
                            content,
                            exploring fresh perspectives, and embracing the forefront of literary exploration.</p>
                    </div>
                    <div class="about-text">We thrive on crafting compelling content, exploring new perspectives, and
                        pushing
                ...
                <div id="w-node-_3740d9dd-9ddb-7f94-7123-fbf6dd1d3aa6-4cfc731f" class="w-layout-cell about-cell"><img
                        src="../images/65770613e6074c335d770a88_about.jpg" loading="lazy"
                    ...
                    <div class="author-list-wrapper w-dyn-list">
                        <div role="list" class="author-list w-dyn-items">
                            <div role="listitem" class="w-dyn-item">
                                <div class="author-item">
                                    <div class="author-item-upper"><img alt="" loading="lazy"
                                            src="../images/65776bfacaa42837d45bdf14_author1.jpg"
                                            class="author-image" /><a href="author/demetris-osinski.html"
                                            class="button author-button w-button">profile</a></div>
                                    <h5 class="author-name">Demetris Osinski</h5>
                                    <p class="author-bio">A dedicated environmentalist, Alex sheds light on pressing
                                        ecological issues and
                                        sustainability practices. His articles inspire action and offer practical
                                        insights for a greener
                                        future.</p>
                                </div>
                            </div>
                            <div role="listitem" class="w-dyn-item">
                                <div class="author-item">
                                    <div class="author-item-upper"><img alt="" loading="lazy"
                                            src="../images/65776c11346eaf4660a2fa27_author2.jpg"
                                            class="author-image" /><a href="author/alex-carter.html"
                                            class="button author-button w-button">profile</a></div>
                            ...
                            <div role="listitem" class="w-dyn-item">
                                <div class="author-item">
                                    <div class="author-item-upper"><img alt="" loading="lazy"
                                            src="../images/65776c406131c7e9b65a3b47_author3.jpg"
                                            class="author-image" /><a href="author/gisselle-schiller.html"
                                            class="button author-button w-button">profile</a></div>
                            ...
                            <div role="listitem" class="w-dyn-item">
                                <div class="author-item">
                                    <div class="author-item-upper"><img alt="" loading="lazy"
                                            src="../images/65776c51f61615907dbb9956_author4.jpg"
                                            class="author-image" /><a href="author/mike-ivans.html"
                                            class="button author-button w-button">profile</a></div>
                    ...
                    <div id="w-node-dd3feab8-20cd-504e-dfab-1b390f44e336-0f44e319"
                        ...
                        <div class="w-form">
                            <form id="email-form" name="email-form" data-name="Email Form" method="get"
                                class="form" data-wf-page-id="65795d101c18091a4cfc731f"
    ...
    <script src="../js/jquery-3.5.1.min.dc5e7f18c89dcc.js?site=6577019a915bb98abc733614" type="text/javascript"
