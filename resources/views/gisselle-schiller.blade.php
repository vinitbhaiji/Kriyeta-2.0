  ...
  <section class="author-hero-section">
    <div class="w-layout-blockcontainer main-container w-container">
      <div class="single-author-inner"><img alt="" loading="lazy"
          src="/public/assets/images/65776c406131c7e9b65a3b47_author3.jpg"
          class="single-author-img" />
        <div class="single-author-text-box">
          <h4 class="single-author-heading">Liam Nison</h4>
        ...
        <div class="author-socials"><a href="https://www.bing.com/" target="_blank"
            class="author-social-link w-inline-block"><img
              src="/public/assets/images/657979ee694f43158561101e_socials_03.png"
              loading="lazy" alt="" class="author-social-icon" /></a><a href="https://www.imdb.com/" target="_blank"
            class="author-social-link w-inline-block"><img
            ...
            class="author-social-link w-inline-block"><img
              ...
              loading="lazy" alt="" class="author-social-icon" /></a><a href="https://www.whatsapp.com/" target="_blank"
            class="author-social-link w-inline-block"><img
              src="/public/assets/images/657979ee4c6becf17e30a7a2_socials_09.png"
              loading="lazy" alt="" class="author-social-icon" /></a><a href="https://adobe.com/" target="_blank"
            class="author-social-link w-inline-block"><img
      ...
      <div class="blog-list-wrapper w-dyn-list">
        <div role="list" class="blog-list w-dyn-items">
          <div role="listitem" class="w-dyn-item"><a data-w-id="59f2e108-1a90-8e1e-bc5c-73ea74f3bef0"
              href="../blog-posts/oceans-unexplored-secrets-of-the-deep.html" class="blog-list-item w-inline-block"><img
                alt="" loading="lazy"
          ...
          <div role="listitem" class="w-dyn-item"><a data-w-id="59f2e108-1a90-8e1e-bc5c-73ea74f3bef0"
              href="../blog-posts/beyond-books-practical-learning-adventures.html"
              class="blog-list-item w-inline-block"><img alt="" loading="lazy"
                ...
                class="blog-main-image" />
              <div class="blog-meta">
                <div class="category-text-style">Education</div>
                <div class="reading-time">5 min Read</div><img
                  src="/public/assets/images/65770613c4602911abe0fa5a_arrow.png"
                  loading="lazy" style="opacity:0" alt="" class="blog-meta-arrow" />
              </div>
              <h4 class="main-blog-title">Beyond Books: Practical Learning Adventures</h4>
            </a></div>
          <div role="listitem" class="w-dyn-item"><a data-w-id="59f2e108-1a90-8e1e-bc5c-73ea74f3bef0"
              href="../blog-posts/aerial-perspectives-birds-eye-nature-views.html"
              class="blog-list-item w-inline-block"><img alt="" loading="lazy"
              ...
              <h4 class="main-blog-title">Aerial Perspectives: Birds-Eye Nature Views</h4>
            </a></div>
          <div role="listitem" class="w-dyn-item"><a data-w-id="59f2e108-1a90-8e1e-bc5c-73ea74f3bef0"
              href="../blog-posts/teachers-toolbox-strategies-for-success.html"
              class="blog-list-item w-inline-block"><img alt="" loading="lazy"
                src="/public/assets/images/65783070010dc346d091ec11_post19.jpg"
                sizes="(max-width: 479px) 100vw, (max-width: 767px) 92vw, (max-width: 991px) 94vw, (max-width: 1439px) 29vw, 416px"
              ...
              <h4 class="main-blog-title">Teacher&#x27;s Toolbox: Strategies for Success</h4>
            </a></div>
          <div role="listitem" class="w-dyn-item"><a data-w-id="59f2e108-1a90-8e1e-bc5c-73ea74f3bef0"
              href="../blog-posts/tech-talk-advancements-in-science-and-tech.html"
              class="blog-list-item w-inline-block"><img alt="" loading="lazy"
                ...
                class="blog-main-image" />
              <div class="blog-meta">
                <div class="category-text-style">Science</div>
                <div class="reading-time">5 min Read</div><img
                  src="/public/assets/images/65770613c4602911abe0fa5a_arrow.png"
                  loading="lazy" style="opacity:0" alt="" class="blog-meta-arrow" />
              </div>
              <h4 class="main-blog-title">Tech Talk: Advancements in Science and Tech</h4>
            </a></div>
          <div role="listitem" class="w-dyn-item"><a data-w-id="59f2e108-1a90-8e1e-bc5c-73ea74f3bef0"
              href="../blog-posts/natures-palette-colors-of-the-great-outdoors.html"
              class="blog-list-item w-inline-block"><img alt="" loading="lazy"
              ...
              <h4 class="main-blog-title">Nature&#x27;s Palette: Colors of the Great Outdoors</h4>
            </a></div>
          <div role="listitem" class="w-dyn-item"><a data-w-id="59f2e108-1a90-8e1e-bc5c-73ea74f3bef0"
              href="../blog-posts/student-chronicles-life-in-the-academic-lane.html"
              class="blog-list-item w-inline-block"><img alt="" loading="lazy"
                src="/public/assets/images/65783070010dc346d091ec11_post19.jpg"
                sizes="(max-width: 479px) 100vw, (max-width: 767px) 92vw, (max-width: 991px) 94vw, (max-width: 1439px) 29vw, 416px"
                srcset="https://assets-global.website-files.com/65770570a2946a7c83492a9c/65783070010dc346d091ec11_post19-p-500.jpg 500w, https://assets-global.website-files.com/65770570a2946a7c83492a9c/65783070010dc346d091ec11_post19.jpg 849w"
              ...
              <h4 class="main-blog-title">Student Chronicles: Life in the Academic Lane</h4>
            </a></div>
          <div role="listitem" class="w-dyn-item"><a data-w-id="59f2e108-1a90-8e1e-bc5c-73ea74f3bef0"
              href="../blog-posts/lab-diaries-cutting-edge-scientific-discoveries.html"
              class="blog-list-item w-inline-block"><img alt="" loading="lazy"
              ...
              <h4 class="main-blog-title">Lab Diaries: Cutting-edge Scientific Discoveries</h4>
            </a></div>
          <div role="listitem" class="w-dyn-item"><a data-w-id="59f2e108-1a90-8e1e-bc5c-73ea74f3bef0"
              href="../blog-posts/wild-wonders-exploring-natures-tapestry.html"
              class="blog-list-item w-inline-block"><img alt="" loading="lazy"
              ...
              <h4 class="main-blog-title">Wild Wonders: Exploring Nature&#x27;s Tapestry</h4>
            </a></div>
          <div role="listitem" class="w-dyn-item"><a data-w-id="59f2e108-1a90-8e1e-bc5c-73ea74f3bef0"
              href="../blog-posts/learning-unleashed-innovative-educational-trends.html"
              class="blog-list-item w-inline-block"><img alt="" loading="lazy"
                src="/public/assets/images/65780c82cbcdb5fa71f873b8_post3.jpg"
                class="blog-main-image" />
              <div class="blog-meta">
                <div class="category-text-style">Education</div>
                <div class="reading-time">5 min Read</div><img
              ...
              <h4 class="main-blog-title">Learning Unleashed: Innovative Educational Trends</h4>
            </a></div>
        </div>
      </div>
    </div>
