...
<html data-wf-domain="frenzzy.webflow.io" data-wf-page="6579681c5435b99c06ed37d9"
    ...
    <div class="w-layout-blockcontainer main-container w-container">
      <div data-animation="default" data-collapse="medium" data-duration="400" data-easing="ease" data-easing2="ease"
        ...
        <nav role="navigation" class="main-menu w-nav-menu"><a href="index.html" class="menu-item w-nav-link">Home</a><a
            ...
            href="shop.html" class="menu-item w-nav-link">shop</a><a href="contact.html" aria-current="page"
            class="menu-item w-nav-link w--current">contact</a></nav>
    ...
    <div class="w-layout-blockcontainer main-container w-container">
      <div id="w-node-_367e0197-ec69-162b-09e7-3b1cc66dde4d-06ed37d9"
        ...
        <div id="w-node-_367e0197-ec69-162b-09e7-3b1cc66dde4f-06ed37d9" class="w-layout-cell contatc-cell"><a
            href="tel:+5(123)456-78-90" class="contact-info-links w-inline-block">
            <div class="contact-info-text">+5 (123) 456-78-90</div>
          </a><a href="mailto:test@gmail.com" class="contact-info-links w-inline-block">
            <div class="contact-info-text">info@frenzzy.com</div>
          </a></div>
      </div>
      <div class="contact-form-block w-form">
        <h2 class="form-heading">Send us a MEssage</h2>
        <form id="email-form" name="email-form" data-name="Email Form" method="get"
          data-wf-page-id="6579681c5435b99c06ed37d9" data-wf-element-id="b057ea1d-e3ce-c840-7e56-51fe53607294">
          <div id="w-node-_898cb840-74df-5f6e-2aa5-2965ec797a8b-06ed37d9"
            class="w-layout-layout form-stack wf-layout-layout">
            <div id="w-node-_898cb840-74df-5f6e-2aa5-2965ec797a8c-06ed37d9" class="w-layout-cell form-cell"><input
                class="input-style w-input" maxlength="256" name="name" data-name="Name" placeholder="Name *"
                type="text" id="name" required="" /></div>
            <div id="w-node-_898cb840-74df-5f6e-2aa5-2965ec797a8d-06ed37d9" class="w-layout-cell form-cell"><input
                class="input-style w-input" maxlength="256" name="Last-Name" data-name="Last Name"
                placeholder="Last Name *" type="text" id="Last-Name" required="" /></div>
            <div id="w-node-_0938a258-228f-0d2f-0290-bb3b6d42e6a8-06ed37d9" class="w-layout-cell form-cell"><input
                class="input-style w-input" maxlength="256" name="email" data-name="Email" placeholder="Email Address *"
                type="email" id="email" required="" /></div>
            <div id="w-node-_4593c067-a721-583c-fe46-0882eafb983e-06ed37d9" class="w-layout-cell form-cell"><input
                class="input-style w-input" maxlength="256" name="Phone-Number" data-name="Phone Number"
                placeholder="Phone Number" type="tel" id="Phone-Number" /></div>
            <div id="w-node-ab80280f-afbb-bacc-2bb5-f542c8490ea2-06ed37d9" class="w-layout-cell form-cell"><input
                class="input-style textarea w-input" maxlength="256" name="Message" data-name="Message"
                placeholder="Message *" type="text" id="Message" required="" /></div>
          </div>
          <div class="submit-box">
            <div class="required">*Required Fields</div><input type="submit" data-wait="Please wait..."
          ...
          <div id="w-node-dd3feab8-20cd-504e-dfab-1b390f44e336-0f44e319" class="w-layout-cell footer-grid-item">
            ...
            <div class="w-form">
              <form id="email-form" name="email-form" data-name="Email Form" method="get" class="form"
                data-wf-page-id="6579681c5435b99c06ed37d9" data-wf-element-id="dd3feab8-20cd-504e-dfab-1b390f44e33c">
