...
<html data-wf-domain="frenzzy.webflow.io" data-wf-page="65770570a2946a7c83492b8e"
...
" data-wf-page-link-href-prefix="" class="w-commerce-commercecartwrapper cart" data-node-type="commerce-cart-wrapper">
  ...
  <section class="inner-page-hero">
    <h2 class="sitemap-heading">Shop</h2>
    <div class="sitemap-subheading">Your Boutique For All Desires</div>
  </section>
  <section class="single-product-section">
    <div class="w-layout-blockcontainer main-container w-container">
      <div id="w-node-_3821ffb4-c030-02ef-12fe-3e4c180ebb4b-83492b8e"
        class="w-layout-layout single-prod-stack wf-layout-layout">
        <div id="w-node-_3821ffb4-c030-02ef-12fe-3e4c180ebb4c-83492b8e" class="w-layout-cell product-img-cell">
          <div class="product-img-wrapper"><img alt="" loading="lazy"
              data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_main_image_4dr%22%2C%22to%22%3A%22src%22%7D%5D"
              src="/public/assets/images/65798905b7012ce767b345c4_product9.jpg"
              sizes="(max-width: 479px) 100vw, (max-width: 767px) 92vw, (max-width: 1439px) 94vw, 1360px"
              srcset="https://assets-global.website-files.com/65770570a2946a7c83492a9c/65798905b7012ce767b345c4_product9-p-500.jpg 500w, https://assets-global.website-files.com/65770570a2946a7c83492a9c/65798905b7012ce767b345c4_product9-p-800.jpg 800w, https://assets-global.website-files.com/65770570a2946a7c83492a9c/65798905b7012ce767b345c4_product9.jpg 830w"
              class="single-prod-img" /></div>
        </div>
        <div id="w-node-_3821ffb4-c030-02ef-12fe-3e4c180ebb4d-83492b8e" class="w-layout-cell product-text-cell">
          <div class="product-text-wrapper">
            <h2 class="prodct-name">Serenity Satin</h2>
            <div data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_price_%22%2C%22to%22%3A%22innerHTML%22%7D%5D"
              class="price">$ 144.00 USD</div>
            <h4 class="single-produ-desc">Product Description</h4>
            <p class="single-prod-text">Lumina Silk is a premium hoodie designed to envelop you in unparalleled comfort
              and style. Crafted with the finest materials, it promises a cozy embrace while exuding a trendy urban
              vibe.</p>
            <div>
              <form data-node-type="commerce-add-to-cart-form" data-commerce-sku-id="65798942d5e65fcc7dc78ee3"
                data-loading-text="Adding to cart..." data-commerce-product-id="6579894194c307d1d94abb71"
                class="w-commerce-commerceaddtocartform">
                <div class="add-to-cart-div">
                  <div class="quantity"><label for="quantity-8609265dbc00fcf3623fa524b47bf22b"
                      class="prod-label w-password-page">Quantity</label><input type="number" pattern="^[0-9]+$"
                      inputMode="numeric" id="quantity-8609265dbc00fcf3623fa524b47bf22b"
                      name="commerce-add-to-cart-quantity-input" min="1"
                      class="w-commerce-commerceaddtocartquantityinput prod-form" value="1" /></div>
                  <div
                    data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_sku_values_3dr%22%2C%22to%22%3A%22optionValues%22%7D%5D"
                    data-commerce-product-sku-values="%7B%22c86a0b622da5b3ca899babb04c18eaa9%22%3A%220810ce5c5fdacb8bf2e96135b7faa865%22%7D"
                    data-node-type="commerce-add-to-cart-option-list"
                    data-commerce-product-id="6579894194c307d1d94abb71" data-preselect-default-variant="false"
                    class="product-size" role="group">
                    <div role="group"><label class="prod-label"></label><select
                        id="option-set-c86a0b622da5b3ca899babb04c18eaa9"
                        data-node-type="commerce-add-to-cart-option-select"
                        data-commerce-option-set-id="c86a0b622da5b3ca899babb04c18eaa9" class="prod-form w-select"
                        required="">
                        <option value="" selected="">Select Color</option>
                        <option value="0810ce5c5fdacb8bf2e96135b7faa865">Main</option>
                        <option value="5394831476d93a4697cfa2a4b604f90a">Pink</option>
                        <option value="43604cfdb125c75224dc9fb84b48c649">Purple</option>
                        <option value="29794ae334235c3addda9ec3621421a4">Green</option>
                        <option value="19546c8c5f37fa80c9606d9bb940425b">Black</option>
                      </select></div>
                  </div>
                </div><input type="submit" data-node-type="commerce-add-to-cart-button"
                  data-loading-text="Adding to cart..." aria-busy="false" aria-haspopup="dialog"
                  class="w-commerce-commerceaddtocartbutton add-to-cart-button" value="Add to Cart" />
              </form>
      ...
      <div class="return-policy">
        <h2 class="return-title">Return Policy</h2>
        <p class="paragraph-2">Our customer-centric return policy is designed to give you peace of mind. You&#x27;ll
          have a generous 30-day window to return items in new condition, and our hassle-free process ensures refunds or
          exchanges are quick and easy.<br />Your satisfaction is our utmost priority, and our dedicated team is always
          here to assist you with any questions or concerns. Shop confidently, knowing we&#x27;ve got your back! We
          strive to make your shopping experience enjoyable from start to finish, with an unwavering commitment to
          excellence. Your trust and satisfaction mean the world to us.</p>
      </div>
    </div>
  </section>
  <div class="footer">
          ...
          <div id="w-node-dd3feab8-20cd-504e-dfab-1b390f44e336-0f44e319" class="w-layout-cell footer-grid-item">
            ...
            <div class="w-form">
              <form id="email-form" name="email-form" data-name="Email Form" method="get" class="form"
                data-wf-page-id="65770570a2946a7c83492b8e" data-wf-element-id="dd3feab8-20cd-504e-dfab-1b390f44e33c">
