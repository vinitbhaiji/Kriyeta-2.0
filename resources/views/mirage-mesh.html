      ...
      <div id="w-node-_3821ffb4-c030-02ef-12fe-3e4c180ebb4b-83492b8e"
        ...
        <div id="w-node-_3821ffb4-c030-02ef-12fe-3e4c180ebb4c-83492b8e" class="w-layout-cell product-img-cell">
          <div class="product-img-wrapper"><img alt="" loading="lazy"
              ...
              src="/public/assets/images/657989325dcfc3a99e25b227_product8.jpg"
              sizes="(max-width: 479px) 100vw, (max-width: 767px) 92vw, (max-width: 1439px) 94vw, 1360px"
              srcset="https://assets-global.website-files.com/65770570a2946a7c83492a9c/657989325dcfc3a99e25b227_product8-p-500.jpg 500w, https://assets-global.website-files.com/65770570a2946a7c83492a9c/657989325dcfc3a99e25b227_product8-p-800.jpg 800w, https://assets-global.website-files.com/65770570a2946a7c83492a9c/657989325dcfc3a99e25b227_product8.jpg 830w"
        ...
        <div id="w-node-_3821ffb4-c030-02ef-12fe-3e4c180ebb4d-83492b8e" class="w-layout-cell product-text-cell">
          <div class="product-text-wrapper">
            <h2 class="prodct-name">Mirage Mesh</h2>
            ...
            <p class="single-prod-text">Lumina Silk is a premium hoodie designed to envelop you in unparalleled comfort
              ...
              vibe.</p>
            <div>
              <form data-node-type="commerce-add-to-cart-form" data-commerce-sku-id="65798a337469b7ef971a50c0"
                data-loading-text="Adding to cart..." data-commerce-product-id="65798a32c4bb798382c379b0"
                ...
                <div class="add-to-cart-div">
                  ...
                  <div
                    ...
                    data-commerce-product-sku-values="%7B%221732e74535eab84a84bc3771a91a2f7b%22%3A%22ec7fda58ee10febf67e9c44ba6ed8f58%22%7D"
                    data-node-type="commerce-add-to-cart-option-list"
                    data-commerce-product-id="65798a32c4bb798382c379b0" data-preselect-default-variant="false"
                    class="product-size" role="group">
                    <div role="group"><label class="prod-label"></label><select
                        id="option-set-1732e74535eab84a84bc3771a91a2f7b"
                        data-node-type="commerce-add-to-cart-option-select"
                        data-commerce-option-set-id="1732e74535eab84a84bc3771a91a2f7b" class="prod-form w-select"
                        required="">
                        <option value="" selected="">Select Color</option>
                        <option value="ec7fda58ee10febf67e9c44ba6ed8f58">Main</option>
                        <option value="20f8f7c7790934e740877b8f83095846">Pink</option>
                        <option value="bf7f8a80a6545925664e20cc701b2089">Purple</option>
                        <option value="e8b297148aac392c3fa7afad019dd73a">Green</option>
                        <option value="1806ec7487eccd900ca095377c975d09">Black</option>
                      </select></div>
                  </div>
