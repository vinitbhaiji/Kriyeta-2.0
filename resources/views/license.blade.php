...
<html data-wf-domain="frenzzy.webflow.io" data-wf-page="6579c3521efc18ec8ba85db2"
...
<head>
  <meta charset="utf-8" />
  <title>License</title>
  <meta content="License" property="og:title" />
  <meta content="License" property="twitter:title" />
...
" data-wf-page-link-href-prefix="" class="w-commerce-commercecartwrapper cart" data-node-type="commerce-cart-wrapper">
  ...
  <section class="inner-page-hero">
    <h2 class="sitemap-heading">Licensing</h2>
  </section>
  <section>
    <div class="w-layout-blockcontainer main-container w-container">
      <div class="style-guide">
        <p class="paragraph-6">All graphical assets in this template are licensed for personal and commercial use. If
          you&#x27;d like to use a specific asset, please check the license below.</p>
        <div class="_30mb-space"></div><a href="https://www.pexels.com/" target="_blank"
          class="sample-link">Pexels.com</a>
        <div class="_30mb-space"></div><a href="https://unsplash.com/" target="_blank"
          class="sample-link">Unsplash.com</a>
        <div class="_30mb-space"></div><a href="https://freepik.com/" target="_blank"
          class="sample-link">freepick.com</a>
        <div class="_30mb-space"></div><a href="https://befonts.com/monroe-typeface.html" target="_blank"
          class="sample-link">befonts.com</a>
      </div>
    </div>
  </section>
  <div class="footer">
          ...
          <div id="w-node-dd3feab8-20cd-504e-dfab-1b390f44e336-0f44e319" class="w-layout-cell footer-grid-item">
            ...
            <div class="w-form">
              <form id="email-form" name="email-form" data-name="Email Form" method="get" class="form"
                data-wf-page-id="6579c3521efc18ec8ba85db2" data-wf-element-id="dd3feab8-20cd-504e-dfab-1b390f44e33c">
    ...
    <div class="w-layout-blockcontainer main-container w-container">
      <div class="copyright">
        <div class="copyright-text">© 2023  Frenzy - Webflow Template. Made by <a href="#" class="copyright-text">Max
            Themes</a></div><a href="license.html" aria-current="page"
          class="copyright-text copyright-license w--current">License</a>
      </div>
    </div>
  </div>
