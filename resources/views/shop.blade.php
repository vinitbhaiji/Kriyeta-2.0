<!DOCTYPE html>
<html data-wf-domain="frenzzy.webflow.io" data-wf-page="6579a9e8cf77fdf107962168"
    ...
    <div class="w-layout-blockcontainer main-container w-container">
      <div data-animation="default" data-collapse="medium" data-duration="400" data-easing="ease" data-easing2="ease"
        ...
        <nav role="navigation" class="main-menu w-nav-menu"><a href="index.html" class="menu-item w-nav-link">Home</a><a
            ...
            href="shop.html" aria-current="page" class="menu-item w-nav-link w--current">shop</a><a href="contact.html"
...
" data-wf-page-link-href-prefix="" class="w-commerce-commercecartwrapper cart" data-node-type="commerce-cart-wrapper">
  ...
  <section class="shop-section">
    <div class="w-layout-blockcontainer main-container w-container">
      <div class="shop-list-wrapper w-dyn-list">
        <div role="list" class="shop-list w-dyn-items">
          <div role="listitem" class="w-dyn-item"><a href="product/lumina-silk.html"
              class="shop-item w-inline-block"><img alt="" loading="lazy"
                data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_main_image_4dr%22%2C%22to%22%3A%22src%22%7D%5D"
                src="/public/assets/images/657989fc1353d59da590ff6a_product1.jpg"
                sizes="(max-width: 479px) 100vw, (max-width: 767px) 92vw, (max-width: 991px) 44vw, (max-width: 1439px) 28vw, 406.671875px"
                ...
                class="shop-image" />
              <h4 class="shop-item-title">Lumina Silk</h4>
              <div class="shop-price-box">
                <div data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_price_%22%2C%22to%22%3A%22innerHTML%22%7D%5D"
                  class="shop-price">$ 159.99 USD</div>
              </div>
              <div class="order-style">order now</div>
            </a></div>
          <div role="listitem" class="w-dyn-item"><a href="product/whisper-weave.html"
              class="shop-item w-inline-block"><img alt="" loading="lazy"
                data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_main_image_4dr%22%2C%22to%22%3A%22src%22%7D%5D"
                ...
                class="shop-image" />
              <h4 class="shop-item-title">Whisper Weave</h4>
              <div class="shop-price-box">
                <div data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_price_%22%2C%22to%22%3A%22innerHTML%22%7D%5D"
                  class="shop-price">$ 143.99 USD</div>
              </div>
              <div class="order-style">order now</div>
            </a></div>
          <div role="listitem" class="w-dyn-item"><a href="product/quanta-cloth.html"
              class="shop-item w-inline-block"><img alt="" loading="lazy"
                data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_main_image_4dr%22%2C%22to%22%3A%22src%22%7D%5D"
                ...
                class="shop-image" />
              <h4 class="shop-item-title">Quanta Cloth</h4>
              <div class="shop-price-box">
                <div data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_price_%22%2C%22to%22%3A%22innerHTML%22%7D%5D"
                  class="shop-price">$ 125.00 USD</div>
              </div>
              <div class="order-style">order now</div>
            </a></div>
          <div role="listitem" class="w-dyn-item"><a href="product/dream-drape.html"
              class="shop-item w-inline-block"><img alt="" loading="lazy"
                data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_main_image_4dr%22%2C%22to%22%3A%22src%22%7D%5D"
                ...
                class="shop-image" />
              <h4 class="shop-item-title">Dream Drape</h4>
              <div class="shop-price-box">
                <div data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_price_%22%2C%22to%22%3A%22innerHTML%22%7D%5D"
                  class="shop-price">$ 144.00 USD</div>
              </div>
              <div class="order-style">order now</div>
            </a></div>
          <div role="listitem" class="w-dyn-item"><a href="product/celestial-chiffon.html"
              class="shop-item w-inline-block"><img alt="" loading="lazy"
                data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_main_image_4dr%22%2C%22to%22%3A%22src%22%7D%5D"
                ...
                class="shop-image" />
              <h4 class="shop-item-title">Celestial Chiffon</h4>
              <div class="shop-price-box">
                <div data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_price_%22%2C%22to%22%3A%22innerHTML%22%7D%5D"
                  class="shop-price">$ 144.00 USD</div>
              </div>
          ...
          <div role="listitem" class="w-dyn-item"><a href="product/radiant-rayon.html"
              class="shop-item w-inline-block"><img alt="" loading="lazy"
                data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_main_image_4dr%22%2C%22to%22%3A%22src%22%7D%5D"
                ...
                class="shop-image" />
              <h4 class="shop-item-title">Radiant Rayon</h4>
              <div class="shop-price-box">
                <div data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_price_%22%2C%22to%22%3A%22innerHTML%22%7D%5D"
                  class="shop-price">$ 144.00 USD</div>
              </div>
          ...
          <div role="listitem" class="w-dyn-item"><a href="product/ethereal-elegance.html"
              class="shop-item w-inline-block"><img alt="" loading="lazy"
                data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_main_image_4dr%22%2C%22to%22%3A%22src%22%7D%5D"
                ...
                class="shop-image" />
              <h4 class="shop-item-title">Ethereal Elegance</h4>
              <div class="shop-price-box">
                <div data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_price_%22%2C%22to%22%3A%22innerHTML%22%7D%5D"
                  class="shop-price">$ 144.00 USD</div>
              </div>
          ...
          <div role="listitem" class="w-dyn-item"><a href="product/mirage-mesh.html"
              class="shop-item w-inline-block"><img alt="" loading="lazy"
                data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_main_image_4dr%22%2C%22to%22%3A%22src%22%7D%5D"
                ...
                class="shop-image" />
              <h4 class="shop-item-title">Mirage Mesh</h4>
              <div class="shop-price-box">
                <div data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_price_%22%2C%22to%22%3A%22innerHTML%22%7D%5D"
                  class="shop-price">$ 144.00 USD</div>
              </div>
          ...
          <div role="listitem" class="w-dyn-item"><a href="product/serenity-satin.html"
              class="shop-item w-inline-block"><img alt="" loading="lazy"
                data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_main_image_4dr%22%2C%22to%22%3A%22src%22%7D%5D"
                ...
                class="shop-image" />
              <h4 class="shop-item-title">Serenity Satin</h4>
              <div class="shop-price-box">
                <div data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_price_%22%2C%22to%22%3A%22innerHTML%22%7D%5D"
                  class="shop-price">$ 144.00 USD</div>
              </div>
          ...
          <div id="w-node-dd3feab8-20cd-504e-dfab-1b390f44e336-0f44e319" class="w-layout-cell footer-grid-item">
            ...
            <div class="w-form">
              <form id="email-form" name="email-form" data-name="Email Form" method="get" class="form"
                data-wf-page-id="6579a9e8cf77fdf107962168" data-wf-element-id="dd3feab8-20cd-504e-dfab-1b390f44e33c">
