...
<html data-wf-domain="frenzzy.webflow.io" data-wf-page="65797d7a5e037aa85c8c8fcd"
    ...
    <div class="w-layout-blockcontainer main-container w-container">
      <div data-animation="default" data-collapse="medium" data-duration="400" data-easing="ease" data-easing2="ease"
        ...
        <nav role="navigation" class="main-menu w-nav-menu"><a href="index.html" class="menu-item w-nav-link">Home</a><a
            href="about.html" class="menu-item w-nav-link">About</a><a href="categories.html" aria-current="page"
      ...
      <div class="home-category-list-wrapper w-dyn-list">
        <div role="list" class="home-category-list category-page-list w-dyn-items">
          <div role="listitem" class="w-dyn-item"><a data-w-id="b1e3ad00-b59e-2147-c718-3ad06976ab73"
              ...
              class="category-grid-item category-page-grid-item w-inline-block"><img alt="" loading="lazy"
          ...
          <div role="listitem" class="w-dyn-item"><a data-w-id="b1e3ad00-b59e-2147-c718-3ad06976ab73"
              href="sport.html" class="category-grid-item category-page-grid-item w-inline-block"><img
                alt="" loading="lazy" src="/public/assets/images/65783182471c329927ff4a48_post2.jpg"
                sizes="(max-width: 479px) 100vw, (max-width: 767px) 96vw, (max-width: 1439px) 30vw, 436.671875px"
          ...
          <div id="w-node-dd3feab8-20cd-504e-dfab-1b390f44e336-0f44e319" class="w-layout-cell footer-grid-item">
            ...
            <div class="w-form">
              <form id="email-form" name="email-form" data-name="Email Form" method="get" class="form"
                data-wf-page-id="65797d7a5e037aa85c8c8fcd" data-wf-element-id="dd3feab8-20cd-504e-dfab-1b390f44e33c">
