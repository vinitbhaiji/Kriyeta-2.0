...
<html data-wf-domain="frenzzy.webflow.io" data-wf-page="6577219781a13a3114a281be" data-wf-site="6577019a915bb98abc733614"
    lang="en">
...
<head>
    ...
    <script type="text/javascript">
        window.__WEBFLOW_CURRENCY_SETTINGS = {
            ...
            "template": "@{{ wf {
    \
    "path\":\"symbol\",\"type\":\"PlainText\"} }} @{{ wf {
    \
    "path\":\"amount\",\"type\":\"CommercePrice\"} }} @{{ wf {
    \
    "path\":\"currencyCode\",\"type\":\"PlainText\"} }}",
    ...
    <div class="header">
        <div class="w-layout-blockcontainer main-container w-container">
            <div data-animation="default" data-collapse="medium" data-duration="400" data-easing="ease"
                data-easing2="ease" role="banner" class="header-inner w-nav"><a href="../index.html"
                    class="logo w-inline-block"><img
                ...
                <nav role="navigation" class="main-menu w-nav-menu"><a href="../index.html"
                        class="menu-item w-nav-link">Home</a><a href="../about.html"
                        class="menu-item w-nav-link">About</a><a href="../categories.html"
                        class="menu-item w-nav-link">categories</a><a href="../blog.html"
                        class="menu-item w-nav-link">posts</a><a href="../shop.html"
                        class="menu-item w-nav-link">shop</a><a href="../contact.html"
...
"
                        ...
                        <div data-node-type="commerce-cart-container" role="dialog"
                            ...
                            <div class="w-commerce-commercecartheader">
                                <h4 class="w-commerce-commercecartheading">Your Cart</h4><a
                                    class="w-commerce-commercecartcloselink w-inline-block" role="button"
    ...
    <section class="author-hero-section">
        <div class="w-layout-blockcontainer main-container w-container">
            <div class="single-author-inner"><img alt="" loading="lazy"
                    src="../images/65776c11346eaf4660a2fa27_author2.jpg" class="single-author-img" />
                <div class="single-author-text-box">
                    <h4 class="single-author-heading">Alex Carter</h4>
                    <p class="single-author-paragraph">A dedicated environmentalist, Alex sheds light on pressing
                        ecological
                        issues and sustainability practices. His articles inspire action and offer practical insights
                        for a greener
                        future.</p>
                </div>
                <div class="author-socials"><a href="https://www.reddit.com/" target="_blank"
                        class="author-social-link w-inline-block"><img
                            src="../images/657979ee694f43158561101e_socials_03.png" loading="lazy" alt=""
                            class="author-social-icon" /></a><a href="https://www.craigslist.org/" target="_blank"
                        class="author-social-link w-inline-block"><img
                            src="../images/657979d08b16b909cd9a0a35_socials_07.png" loading="lazy" alt=""
                            class="author-social-icon" /></a><a href="https://www.ebay.com/" target="_blank"
                        class="author-social-link w-inline-block"><img
                            src="../images/657979ee911cff880a97f044_socials_05.png" loading="lazy" alt=""
                            class="author-social-icon" /></a><a href="https://www.facebook.com/" target="_blank"
                        class="author-social-link w-inline-block"><img
                            src="../images/657979ee4c6becf17e30a7a2_socials_09.png" loading="lazy" alt=""
                            class="author-social-icon" /></a><a href="https://dropbox.com/" target="_blank"
                        class="author-social-link w-inline-block"><img
                            src="../images/657979ed8e40164b1897c0bb_socials_13.png" loading="lazy" alt=""
                            class="author-social-icon" /></a></div>
            </div>
            ...
            <div class="blog-list-wrapper w-dyn-list">
                <div role="list" class="blog-list w-dyn-items">
                    ...
                    <div role="listitem" class="w-dyn-item"><a data-w-id="59f2e108-1a90-8e1e-bc5c-73ea74f3bef0"
                            ...
                            class="blog-list-item w-inline-block"><img alt="" loading="lazy"
                                src="../images/6578305c159c5e33da267bc0_post18.jpg"
                                sizes="(max-width: 479px) 100vw, (max-width: 767px) 92vw, (max-width: 991px) 94vw, (max-width: 1439px) 29vw, 416px"
                    ...
                    <div role="listitem" class="w-dyn-item"><a data-w-id="59f2e108-1a90-8e1e-bc5c-73ea74f3bef0"
                            ...
                            class="blog-list-item w-inline-block"><img alt="" loading="lazy"
                                src="../images/65780cbcdec1e4824042b46a_post4.jpg" class="blog-main-image" />
                            <div class="blog-meta">
                                <div class="category-text-style">Gaming</div>
                                <div class="reading-time">5 min Read</div><img
                                    src="../images/65770613c4602911abe0fa5a_arrow.png" loading="lazy"
                    ...
                    <div role="listitem" class="w-dyn-item"><a data-w-id="59f2e108-1a90-8e1e-bc5c-73ea74f3bef0"
                            ...
                            class="blog-list-item w-inline-block"><img alt="" loading="lazy"
                                src="../images/65782fa0c3d57d6d7e9a8c15_post14.jpg"
                                sizes="(max-width: 479px) 100vw, (max-width: 767px) 92vw, (max-width: 991px) 94vw, (max-width: 1439px) 29vw, 416px"
                    ...
                    <div role="listitem" class="w-dyn-item"><a data-w-id="59f2e108-1a90-8e1e-bc5c-73ea74f3bef0"
                            ...
                            class="blog-list-item w-inline-block"><img alt="" loading="lazy"
                                src="../images/65782ec113790d5b091d3a46_post9.jpg"
                                sizes="(max-width: 479px) 100vw, (max-width: 767px) 92vw, (max-width: 991px) 94vw, (max-width: 1439px) 29vw, 416px"
                    ...
                    <div role="listitem" class="w-dyn-item"><a data-w-id="59f2e108-1a90-8e1e-bc5c-73ea74f3bef0"
                            ...
                            class="blog-list-item w-inline-block"><img alt="" loading="lazy"
                                src="../images/65780d210f0e0f320d32b8ff_post5.jpg"
                                sizes="(max-width: 479px) 100vw, (max-width: 767px) 92vw, (max-width: 991px) 94vw, (max-width: 1439px) 29vw, 416px"
                    ...
                    <div role="listitem" class="w-dyn-item"><a data-w-id="59f2e108-1a90-8e1e-bc5c-73ea74f3bef0"
                            ...
                            class="blog-list-item w-inline-block"><img alt="" loading="lazy"
                                src="../images/65780baa78fffdcd92179e0c_post2.jpg" class="blog-main-image" />
                            <div class="blog-meta">
                                <div class="category-text-style">Sport</div>
                                <div class="reading-time">3 min Read</div><img
                                    src="../images/65770613c4602911abe0fa5a_arrow.png" loading="lazy"
    ...
    <div class="footer">
            ...
            <div class="w-layout-blockcontainer main-container w-container">
                <div id="w-node-dd3feab8-20cd-504e-dfab-1b390f44e31c-0f44e319"
                    ...
                    <div id="w-node-dd3feab8-20cd-504e-dfab-1b390f44e336-0f44e319"
                        ...
                        <p class="footer-text">Stay ahead of the curve with our exclusive daily newsletter directly in
                            your inbox!
                        </p>
                        <div class="w-form">
                            <form id="email-form" name="email-form" data-name="Email Form" method="get"
                                class="form" data-wf-page-id="6577219781a13a3114a281be"
        ...
        <div class="w-layout-blockcontainer main-container w-container">
            <div class="copyright">
                <div class="copyright-text">© 2023  Frenzy - Webflow Template. Made by <a href="#"
                        class="copyright-text">Max
                        Themes</a></div><a href="../utility-pages/license.html"
                    class="copyright-text copyright-license">License</a>
            </div>
        </div>
    </div>
