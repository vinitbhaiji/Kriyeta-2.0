      ...
      <div id="w-node-_3821ffb4-c030-02ef-12fe-3e4c180ebb4b-83492b8e"
        ...
        <div id="w-node-_3821ffb4-c030-02ef-12fe-3e4c180ebb4c-83492b8e" class="w-layout-cell product-img-cell">
          <div class="product-img-wrapper"><img alt="" loading="lazy"
              ...
              src="/public/assets/images/65798aa9efdd1c29812876b3_product5.jpg"
              sizes="(max-width: 479px) 100vw, (max-width: 767px) 92vw, (max-width: 1439px) 94vw, 1360px"
              srcset="https://assets-global.website-files.com/65770570a2946a7c83492a9c/65798aa9efdd1c29812876b3_product5-p-500.jpg 500w, https://assets-global.website-files.com/65770570a2946a7c83492a9c/65798aa9efdd1c29812876b3_product5-p-800.jpg 800w, https://assets-global.website-files.com/65770570a2946a7c83492a9c/65798aa9efdd1c29812876b3_product5.jpg 830w"
        ...
        <div id="w-node-_3821ffb4-c030-02ef-12fe-3e4c180ebb4d-83492b8e" class="w-layout-cell product-text-cell">
          <div class="product-text-wrapper">
            <h2 class="prodct-name">Celestial Chiffon</h2>
            ...
            <p class="single-prod-text">Lumina Silk is a premium hoodie designed to envelop you in unparalleled comfort
              ...
              vibe.</p>
            <div>
              <form data-node-type="commerce-add-to-cart-form" data-commerce-sku-id="65798aaf88a1dafb64cc30ee"
                data-loading-text="Adding to cart..." data-commerce-product-id="65798aaea563dedc261f2c04"
                ...
                <div class="add-to-cart-div">
                  ...
                  <div
                    ...
                    data-commerce-product-sku-values="%7B%22a9e69f366ffbc67cce9a6929b47de2d3%22%3A%2258efdf4a16cc601d1d42275e9d8fa6bc%22%7D"
                    data-node-type="commerce-add-to-cart-option-list"
                    data-commerce-product-id="65798aaea563dedc261f2c04" data-preselect-default-variant="false"
                    class="product-size" role="group">
                    <div role="group"><label class="prod-label"></label><select
                        id="option-set-a9e69f366ffbc67cce9a6929b47de2d3"
                        data-node-type="commerce-add-to-cart-option-select"
                        data-commerce-option-set-id="a9e69f366ffbc67cce9a6929b47de2d3" class="prod-form w-select"
                        required="">
                        <option value="" selected="">Select Color</option>
                        <option value="58efdf4a16cc601d1d42275e9d8fa6bc">Main</option>
                        <option value="9c5192d3e1ce193ed5f2c444c5e141f9">Pink</option>
                        <option value="ab4f4d061578a9fc467b780a5ff947eb">Purple</option>
                        <option value="97776ef920bec9dd8b542c3a3fe2d743">Green</option>
                        <option value="a8cd9c8349f03b2fd364265024b8002e">Black</option>
                      </select></div>
                  </div>
